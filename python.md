...
![Status](https://img.shields.io/badge/Status-In_Progress-00C851?style=for-the-badge)

Welcome to your 6-month roadmap to become a Data Scientist. You're not just learning—you're leveling up. Let's break it down week by week.
...
| :--- | :---: | :--- |
| 1 | 1–4 | Python Fundamentals & OOP |
| 2 | 5–8 | Math & Statistics |
| 3 | 9–11 | Data Preprocessing & Visualization |
| 4 | 11–13 | SQL & Databases |
| 5 | 15–21 | Machine Learning |
| 6 | 22–25 | Deep Learning |
| 7 | 25–26 | Specialization & Capstone |
...
[📁 Daily Folder Structure](daily/week_1/)

| Day | Focus Area | Daily File | Questions |
|-----|------------|------------|-----------|
| 1 | Setup + Variables + Data Types | [Day 1](daily/week_1/day_1/day_1.md) | 1-4 |
| 2 | Strings + Print + Input | [Day 2](daily/week_1/day_2/day_2.md) | 5-9 |
| 3 | Operators | [Day 3](daily/week_1/day_3/day_3.md) | 10-14 |
| 4 | Conditionals | [Day 4](daily/week_1/day_4/day_4.md) | 15-19 |
| 5 | For Loop + Range | [Day 5](daily/week_1/day_5/day_5.md) | 20-24 |
| 6 | While Loop + Break/Continue | [Day 6](daily/week_1/day_6/day_6.md) | 25-30 |
| 7 | Review + Weekly Challenge | [Day 7](daily/week_1/day_7/day_7.md) | Challenge |

### Week 2: Functions, Lists, Tuples, Dictionaries, Sets
[📁 Daily Folder Structure](daily/week_2/)

| Day | Focus Area | Daily File | Questions |
|-----|------------|------------|-----------|
| 8 | Functions Intro | [Day 8](daily/week_2/day_8/day_8.md) | 1-4 |
| 9 | Functions Deep | [Day 9](daily/week_2/day_9/day_9.md) | 5-8 |
| 10 | Lists Deep Dive | [Day 10](daily/week_2/day_10/day_10.md) | 9-12 |
| 11 | Tuples & Sets | [Day 11](daily/week_2/day_11/day_11.md) | 13-16 |
| 12 | Dictionaries | [Day 12](daily/week_2/day_12/day_12.md) | 17-20 |
| 13 | Advanced DS | [Day 13](daily/week_2/day_13/day_13.md) | 21-24 |
| 14 | Review & Challenge | [Day 14](daily/week_2/day_14/day_14.md) | 25-30 |
...
**🎥 Recommended Resource**: [Python Full Course (12h, Hindi)](https://youtu.be/_aWbUudZ5Yo?si=IRekgyhVktHlSGsR)
- **Current Progress**: Starting from **07:24:17 (OOP)**
- **Free Book**: [Google Drive](https://drive.google.com/file/d/1dUp1...)
- **Source Code**: [GitHub](https://github.com/AkarshVyas/Python-...)

**📺 Course Timeline (Remaining):**
| Time | Topic |
| :--- | :--- |
| 07:24:17 | Object Oriented Programming (OOP) |
| 09:18:32 | Advanced Python concepts |
| 10:05:09 | OOPs project — Bank Management System |
| 11:34:50 | Outro |
...
**🎥 Recommended Resource**: [5-hour full Statistics session](https://www.youtube.com/watch?v=eF7HoC-cLRM&t=17267s)
...
- [ ] Q5. Find the indices of non-zero elements from [1,2,0,0,4,0].
...
**🎥 Resources**:
- [NumPy](https://www.youtube.com/watch?v=Utgwk0r9Zq4&t=365s)
...
**🎥 Resource**: [ML Playlist](https://youtube.com/playlist?list=PLaldQ9PzZd9qT0KsKJ7yCq70iFFP3MFJ5&si=zPjf0Wb98hFbaYLx)
...
## 📌 Related Files
- [Daily Progress](../2026/june/daily_progress_tracking/)
- [2026 Roadmap](../2026/)
