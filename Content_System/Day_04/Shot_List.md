...
1. **Terminal scrolling infinitely**: POV angle. Purpose: Establish time/progress.
2. **Panicked hitting Ctrl+C**: Over the shoulder. Purpose: Show the struggle/action.
3. **Slumping in chair relieved**: Screen recording. Purpose: Show the code working (or failing).
