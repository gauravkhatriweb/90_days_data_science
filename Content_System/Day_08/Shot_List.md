...
1. **Running script then opening .txt file**: POV angle. Purpose: Establish time/progress.
2. **Typing 'with open'**: Over the shoulder. Purpose: Show the struggle/action.
3. **Nodding in approval at screen**: Screen recording. Purpose: Show the code working (or failing).
