...
1. **Clean Python Dictionary on screen**: POV angle. Purpose: Establish time/progress.
2. **Working at desk during golden hour**: Over the shoulder. Purpose: Show the struggle/action.
3. **Crossing Day 6 on calendar**: Screen recording. Purpose: Show the code working (or failing).
