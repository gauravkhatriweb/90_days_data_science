...
1. **Talking to the laptop**: POV angle. Purpose: Establish time/progress.
2. **Messy if-elif-else block**: Over the shoulder. Purpose: Show the struggle/action.
3. **Rubber duck on desk**: Screen recording. Purpose: Show the code working (or failing).
