...
1. **GitHub 7-day streak**: POV angle. Purpose: Establish time/progress.
2. **Replacing code with calculate_data()**: Over the shoulder. Purpose: Show the struggle/action.
3. **Stretching arms up at desk**: Screen recording. Purpose: Show the code working (or failing).
