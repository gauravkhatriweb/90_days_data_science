...
1. **Crossing Day 10 with thick marker**: POV angle. Purpose: Establish time/progress.
2. **Scrolling clean OOP code with __init__**: Over the shoulder. Purpose: Show the struggle/action.
3. **Confident smile at camera**: Screen recording. Purpose: Show the code working (or failing).
