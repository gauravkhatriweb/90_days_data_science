...
1. **Cross off Day 1 on calendar**: POV angle. Purpose: Establish time/progress.
2. **Staring intently at laptop**: Over the shoulder. Purpose: Show the struggle/action.
3. **Typing print('Hello World')**: Screen recording. Purpose: Show the code working (or failing).
