...
1. **Big red TypeError on screen**: POV angle. Purpose: Establish time/progress.
2. **Aggressively rubbing face**: Over the shoulder. Purpose: Show the struggle/action.
3. **Typing int() and hitting run**: Screen recording. Purpose: Show the code working (or failing).
